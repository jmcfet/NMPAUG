...
$U.core.Configuration = ( function() {
	...
	var Configuration = {
		...
		SDP_CONFIG : {
			HEAD_END : "OTT",
			URL : "srmadridlab.nagra.com/ms23gen",
		...
		MDS_CONFIG : {
			MDS_URL : "srmadridlab.nagra.com/ms23gen",
		...
		//               VIDEO_PATH : "http://10.11.66.99/CDN/SR1/transcodedVideos/",
		...
		*/
		...
		SEARCH_FIELDS : ["title", "actors", "description", "directors", "synopsis" // can include "title", "actors", "description", "synopsis", "directors"
		],

		// Mobile network settingsó
		MOBILE_NETWORK : {
