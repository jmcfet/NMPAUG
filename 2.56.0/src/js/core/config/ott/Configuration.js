...
$U.core.Configuration = ( function() {
	...
	var Configuration = {
		...
		VIDEO_PATH : "http://186.75.76.2/vod/",
		TRAILER_VIDEO_PATH : "http://186.75.76.2/vod/",
		...
		*/
		...
		VIDEO_ENCODER: VIDEO_ENCODERS.RGB,

		// If VOD asset fetch be attempted for catchup events
		FETCH_CATCHUP_VOD_ASSETS: false,
