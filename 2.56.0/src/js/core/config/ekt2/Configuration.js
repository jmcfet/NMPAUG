...
$U.core.Configuration = ( function() {
	...
	var Configuration = {
		...
		SDP_CONFIG : {
			HEAD_END : "OTT",
			URL : "abra.abertistelecom.com:8080",
		...
		MDS_CONFIG : {
			MDS_URL : "abra.abertistelecom.com:8080",
			MDS_PATH : "/metadata/delivery",
			MDS_PORT : "",
			SERVICE_PROVIDER : "LAB"
		},
		...
		SUGGESTIONS_MINIMUM_RATING : 200,
		...
		MAXIMUM_STREAM_RESTRICTION : true,
		...
		LOCKER_CONFIG : {
			URL : "abra.abertistelecom.com",
			PORT : "8080",
			SERVICE_PATH : "api/npvrlocker/v1/",
			SECURITY : false,
			PROVIDER : "LAB",
			HARMONIC_PATH : "abra.abertistelecom.com"
		},
