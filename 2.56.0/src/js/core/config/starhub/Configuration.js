...
$U.core.Configuration = ( function() {
	...
	var Configuration = {
		...
		MDS_CONFIG : {
			MDS_URL : "172.28.136.12",
			MDS_PATH : "/metadata/delivery",
			MDS_PORT : "",
			MDS_TIMEOUT: 9000,
			SERVICE_PROVIDER : "SCV"
		},
		TRAXIS_URL  : "http://172.28.2.161/Traxis/",
		SMARTCARDID : "",
		...
		// If the Channels need to be set to a different local use the locale as the key:
		CHANNEL_LOCALES : {
			zh_sg : "en_GB"
		},
		...
		MAX_PARENTAL_RATING : 21,

		//Array of parental ratings to hide from the parental control dialog (must be Strings)
		HIDE_PARENTAL_RATINGS : ["0"],
		...
		getParentalRatings : function() {
			PARENTAL_RATINGS = {
				...
				5 : {
					...
					imgCSSClass : "mc-parental-rating-G"
				},
				6 : {
					ratingCode : "PG",
				...
				13 : {
					...
					imgCSSClass : "mc-parental-rating-PG13"
				},
				16 : {
					ratingCode : "NC16",
					description : $U.core.util.StringHelper.getString("txtRating5"),
					imgCSSClass : "mc-parental-rating-NC16"
				},
				18 : {
					ratingCode : "M18",
					description : $U.core.util.StringHelper.getString("txtRating6"),
					imgCSSClass : "mc-parental-rating-M18"
				},
				21 : {
					ratingCode : "",
					description : $U.core.util.StringHelper.getString("txtRating1"),
					imgCSSClass : "mc-parental-rating-R21"
				}
			};
		...
		// if want to search across multiple fields can add in one of: ["title", "actors", "description", "directors"]
		SEARCH_FIELDS: ["title"],
